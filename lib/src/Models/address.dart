...
class Adress {
  ...
  factory Adress.fromJson(Map<String, dynamic> json) => Adress(
    ...
    lat:json["lat"] is Double ? double.tryParse(json["lat"])??0.0:double.tryParse(json["lat"].toString()),
    lng: json["lng"] is Double? double.tryParse(json["lng"])??0.0:double.tryParse(json["lng"].toString()),
  );
